...
# Needs to install hh-suite3 package first. https://vogdb.org/research/hh-suite 
# The hhalign from hh-suite aligns much better than bio.pairwise2.local module.
# Output saves in /ifs/data/c2b2/bh_lab/hz2592/tmp/HH_output/
# ----------------------------------------------------------------------
...
#Usage: python MapIndex_PDB_GeneSeq_HHalign.py PDB chainID Fastafile SeqMap.output
...
"""
"""
hh_dir = "/ifs/data/c2b2/bh_lab/hz2592/tmp/HH_output/" #tempfile.TemporaryDirectory()
